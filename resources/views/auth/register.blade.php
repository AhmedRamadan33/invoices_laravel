                                ...
                                <div class="card-sigin">
                                    ...
                                    <div class="card-sigin">
                                        <div class="main-signup-header">
                                            <h2>مرحبا بك</h2>
                                            <h5 class="font-weight-semibold mb-4"> تسجيل حساب</h5>
                                            <form method="POST" action="{{ route('register') }}">
                                                ...
                                                <div class="form-group">
                                                    <input id="email" type="email" placeholder="الايميل"
                                                ...
                                                <div class="form-group">
                                                    <input id="password" type="password" placeholder="كلمه السر"
                                                ...
                                                <div class="form-group">
                                                    <input id="password-confirm" type="password" class="form-control"
                                                        placeholder="تاكيد كلمه السر" name="password_confirmation" required
