            ...
            <div class="dropdown user-pro-body">
                <div class="">
                    <img alt="user-img" class="avatar avatar-xl brround"
                        src="{{ URL::asset('files/'.Auth::user()->image) }}"><span
        ...
        <ul class="side-menu">
                ...
                <li class="slide">
                    ...
                    <ul class="slide-menu">
                        ...
                        @can('الفواتير المدفوعة')
                            <li><a class="slide-item" href="{{ route('invoicesPaid') }}">الفواتير المدفوعة</a>
                            @endcan

                        </li>

                        @can('الفواتير الغير مدفوعة')
                            <li><a class="slide-item" href="{{ route('invoicesUnpaid') }}">الفواتير
                                    الغيرمدفوعة</a>
                            </li>
                        @endcan

                        @can('الفواتير المدفوعة')
                            <li><a class="slide-item" href="{{ route('invoicesPartial') }}">الفواتير المدفوعة
                                    جزئيا</a>
                            </li>
                        @endcan

                        @can('ارشيف الفواتير')
                            <li><a class="slide-item" href="{{ route('invoicesArchive') }}">ارشيف الفواتير</a></li>
                        @endcan
                    </ul>
                </li>
            @endcan
            ...
            @can('التقارير')
                <li class="slide">
                    ...
                    <ul class="slide-menu">
                        @can('تقرير الفواتير')
                            <li><a class="slide-item" href="{{ route('reportsINV.index') }}">تقارير الفواتير</a>
                            </li>
                        @endcan

                        @can('تقرير العملاء')
                            <li><a class="slide-item" href="{{ route('reportsCust.index') }}">تقارير العملاء</a>
                            </li>
                        @endcan
                    </ul>
                </li>
