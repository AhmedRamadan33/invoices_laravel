				...
				<div class="container-fluid">
					...
					<div class="main-header-right">
						...
						<div class="nav nav-item  navbar-nav-right ml-auto">
							...
							@can('الاشعارات')
							<div class="dropdown nav-item main-header-notification  xx">
								...
								<div class="dropdown-menu">
									...
									<span class="badge badge-pill badge-warning mr-5 my-auto  float-left">تمييز الكل كمقروء</span>
											</a>
										</div>
										<p id="notifications_count" class="dropdown-title-text subtext mb-0 text-white op-6 pb-0 tx-12 ">عدد الاشعارات الغير مقروءة : 
							...
							<div class="dropdown main-profile-menu nav nav-item nav-link">
								<a class="profile-user d-flex" href=""><img alt="" src="{{URL::asset('files/'.Auth::user()->image)}}"></a>
								<div class="dropdown-menu">
									<div class="main-header-profile bg-primary p-3">
										<div class="d-flex wd-100p">
											<div class="main-img-user"><img alt="" src="{{URL::asset('files/'.Auth::user()->image)}}" class=""></div>
