...
@section('title')
    قائمه الفواتير - برنامج الفواتير
@endsection
@section('page-header')
    <!-- breadcrumb -->
            ...
            <div class="card mg-b-20">
                <div class="card-header pb-0">
                    <div class="d-flex justify-content-between">
                        <a href="{{ route('invoices.create') }}" class="btn btn-outline-secondary ">اضافه فاتوره</a>
                    </div>
                </div>
                <div class="card-body">
                                ...
                                @foreach ($invoices as $item)
                                    <tr>
                                        ...
                                        <td>
                                                    ...
                                                    <a class="ml-3"
                                                        href=" {{ route('invoices.edit', $item->id) }} "> <i
                                                            class="text-warning fas fa-pen"></i>
                                                        تعديل الفاتورة </a>
                                                    ...
                                                    <a class="ml-3" href="{{route('Status_edit',$item->id)}}">
                                                        <i class=" text-success fas fa-money-bill"></i>&nbsp;&nbsp;تغير حالة
                                                        الدفع</a>

                                                    <a class="ml-3" href="{{route('invoices.archive',$item->id)}}">
                                                        <i class="text-warning fas fa-exchange-alt"></i>&nbsp;&nbsp;نقل الي الارشيف</a>

                                                    <a class="" href="{{route('Print_invoice' ,$item->id )}}"><i
