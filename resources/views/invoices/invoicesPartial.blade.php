...
@section('title')
    قائمه الفواتير المدفوعه جزئيا - برنامج الفواتير
@endsection
@section('page-header')
    <!-- breadcrumb -->
                                                ...
                                                <div class="dropdown-menu tx-13">
                                                    <a class="dropdown-item"
                                                        href=" {{ route('invoices.edit', $item->id) }} "> <i
                                                            class="text-danger fas fa-pen"></i>
                                                        تعديل الفاتورة </a>
                                                    ...
                                                    <a class="dropdown-item" href="{{route('Status_edit',$item->id)}}">
                                                        <i class=" text-success fas fa-money-bill"></i>&nbsp;&nbsp;تغير حالة
                                                        الدفع</a>

                                                        <a class="dropdown-item" href="{{route('invoices.archive',$item->id)}}">
